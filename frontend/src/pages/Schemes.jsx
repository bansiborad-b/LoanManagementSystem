...
const Schemes = () => {
  ...
  return (
    <div className="overflow-y-auto no-scrollbar h-screen bg-gray-50">
      ...
      <div class="w-full max-w-full xl:px-14 p-4">
        <div className="flex flex-col md:flex-row gap-4 md:py-8 md:px-6  p-4 shadow-lg items-center justify-evenly bg-white rounded-2xl">
          <input
            ...
            type="text"
            placeholder="Search..."
            class="w-full md:w-1/3 px-4 py-2 border border-gray-300 rounded-xl focus:outline-none focus:ring-1 focus:ring-black"
          />
      ...
      <div class="w-full max-w-full xl:px-14 p-4 py-10">
